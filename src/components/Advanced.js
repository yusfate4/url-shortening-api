...
export default function Advanced() {
  return (
    <>
      <section className="bg-gray-100 pt-20 pb-32 lg:pb-40">
        <div className="max-width">
          ...
          <div className="card relative grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article className="bg-white p-5 rounded relative">
              ...
              />
              <h3 className="text-slate-800 mt-5 text-lg mb-2 font-bold">
                Brand Recognition
              </h3>
            ...
            <article className="bg-white p-5 relative rounded">
              <img
                src={records}
                alt=""
                className="p-3 -mt-12 bg-slate-800 rounded-full"
